...
from .model_dtat import DTATAdapter
...
def load_model(
    ...
    if model is None and not lazy_load:
        ...
        # Add DTAT adapter for SFT
        if is_trainable and finetuning_args.stage == "sft":
            if not hasattr(model, "dtat_adapter"):
                ...
                logger.info("Added DTAT adapter to model for SFT training.")
